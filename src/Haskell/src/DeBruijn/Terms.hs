...
-- data DeBruijnF r = TVarF Int
--                  | TAbsF r
--                  | TAppF r r
--   deriving (Show, Eq, Functor, Foldable, Traversable)

-- data DLabel = AbsL | AppL

-- instance Ast' DeBruijnF DLabel Int where
--   toAst (TVarF x) = LeafF x
--   toAst (TAbsF r) = NodeF AbsL [r]
--   toAst (TAppF r1 r2) = NodeF AppL [r1, r2]
